	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description: 'ID of the creating user (saved as id_creador). Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
		...
		options: [
			{
				...
				typeOptions: { loadOptionsMethod: 'getUsers' },
				default: '',
				description: 'ID of the editing user. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
