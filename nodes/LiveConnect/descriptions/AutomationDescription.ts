	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'Required if Type is Message and the channel is WABA/WABA Meta. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>',
			...
			},
			{
				...
				default: '',
				description:
					'Required if Type is Message. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'Only applies if Type is Message and the channel is WABA/WABA Meta. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>',
				routing: { send: { type: 'body', property: 'id_plantilla' } },
			},
			{
				displayName: 'Channel Name or ID',
				...
				default: '',
				description:
					'Only applies if Type is Message. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>',
				routing: { send: { type: 'body', property: 'id_canal' } },
			},
			{
				displayName: 'Message',
